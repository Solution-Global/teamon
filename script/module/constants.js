...
//define("SOFTWARE_UPDATE_URL_BASE", SOFTWARE_UPDATE_IP_DEV + ":" + SOFTWARE_UPDATE_PORT);    // blue dev
define("SOFTWARE_UPDATE_URL_BASE", SOFTWARE_UPDATE_IP_PROD + ":" + SOFTWARE_UPDATE_PORT);   // ubiz
